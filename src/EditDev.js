      ...
      <>
        <Modal className="mintingNftModal" show={this.props.modalDev}>
          <Form className="nftForm" onSubmit={this.handleSubmit} encType='multipart/form-data'>
            ...
            <Form.Control onChange={this.handleNameChange} id="input" type='text' value={this.state.name} className='name' />
            <Form.Label>Bio:</Form.Label>
            <Form.Control id="input" onChange={this.handleBioChange} type='text' as='textarea' value={this.state.bio} name='Bio' />
            <Form.Label>linkedIn:</Form.Label>
            <Form.Control id="input" onChange={this.handlelinkedInChange} type='text' value={this.state.linkedIn} name='linkedIn' />
            <Form.Label>Github:</Form.Label>
            <Form.Control onChange={this.handleGithubChange} id="input" type='text' value={this.state.github} name='github' />
            <Form.Label><BsFillCloudUploadFill />&nbsp; Upload Image:</Form.Label>
            <Form.Control id="input" onChange={this.handleimageUrlChange} type='file' name='image' />
